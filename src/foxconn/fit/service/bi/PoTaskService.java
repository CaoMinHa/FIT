                ...
                if(isSend){
                    if("0".equals(status)){
                        ...
                        if ("FIT_PO_SBU_YEAR_CD_SUM".equalsIgnoreCase(type)) {
                            ...
                            Boolean isSends = EmailUtil.emailsMany(emailList, task[0] + "_" + task[1] + " SBU年度VOC", msg + "</br>&nbsp;&nbsp;<a href=\"https://itpf-test.one-fit.com/fit/login?taskId="+taskId+"\" style=\"color: blue;\">接口平臺</a><br></br>接口平臺登錄賬號是EIP賬號，密碼默認11111111，登錄如有問題，請聯系顧問，郵箱：emji@deloitte.com.cn。<br></br>Best Regards!");
                            if (!isSends) {
                                ajaxResult.put("flag", "fail");
