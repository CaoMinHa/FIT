...
function clickPage(page){
	...
	$("#Content").load("${ctx}/bi/allocationResult/list",{pageNo:$("#PageNo").val(),pageSize:$("#PageSize").val(),
		orderBy:$("#OrderBy").val(),orderDir:$("#OrderDir").val(),
		scenarios:$("#QScenarios").val(),
		entitys:$("#QType").val(),years:$("#QYear").val()},function(){$("#loading").fadeOut(1000);});
}
			...
			<table class="table table-condensed table-hover">
				...
				<c:forEach items="${page.result}" var="mapping" varStatus="sort">
					 <tr>
						...
						<td style="border-right:1px solid #eee;text-align: center;">${mapping.dataType}</td>
