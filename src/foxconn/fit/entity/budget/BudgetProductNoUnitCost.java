 ...
 */
@Entity
@Table(name = "FIT_BUDGET_PRODUCT_UNIT_COST")
public class BudgetProductNoUnitCost {
	...
	//	銷貨成本
	@Column(name = "selling_cost1")
	private String sellingCost1;
	@Column(name = "selling_cost2")
	private String sellingCost2;
	@Column(name = "selling_cost3")
	private String sellingCost3;
	@Column(name = "selling_cost4")
	private String sellingCost4;
	@Column(name = "selling_cost5")
	private String sellingCost5;
	@Column(name = "selling_cost6")
	private String sellingCost6;
	@Column(name = "selling_cost7")
	private String sellingCost7;
	@Column(name = "selling_cost8")
	private String sellingCost8;
	@Column(name = "selling_cost9")
	private String sellingCost9;
	@Column(name = "selling_cost10")
	private String sellingCost10;
	@Column(name = "selling_cost11")
	private String sellingCost11;
	...
	private String materialCostNextyear;
	@Column(name = "labor_cost_nextyear")
	private String laborCostNextyear;
	@Column(name = "manufacture_cost_nextyear")
	private String manufactureCostNextyear;
	@Column(name = "selling_cost_nextyear")
	private String sellingCostNextyear;

	@Column(name = "sales_quantity_twoyear")
	private String salesQuantityTwoyear;
	@Column(name = "material_cost_twoyear")
	private String materialCostTwoyear;
	@Column(name = "labor_cost_twoyear")
	private String laborCostTwoyear;
	@Column(name = "manufacture_cost_twoyear")
	private String manufactureCostTwoyear;
	@Column(name = "selling_cost_twoyear")
	private String sellingCostTwoyear;

	@Column(name = "sales_quantity_threeyear")
	private String salesQuantityThreeyear;
	@Column(name = "material_cost_threeyear")
	private String materialCostThreeyear;
	@Column(name = "labor_cost_threeyear")
	private String laborCostThreeyear;
	@Column(name = "manufacture_cost_threeyear")
	private String manufactureCostThreeyear;
	@Column(name = "selling_cost_threeyear")
	private String sellingCostThreeyear;

	@Column(name = "sales_quantity_fouryear")
	private String salesQuantityFouryear;
	@Column(name = "material_cost_fouryear")
	private String materialCostFouryear;
	@Column(name = "labor_cost_fouryear")
	private String laborCostFouryear;
	@Column(name = "manufacture_cost_fouryear")
	private String manufactureCostFouryear;
	@Column(name = "selling_cost_fouryear")
	private String sellingCostFouryear;
	...
	public String getSellingCost1() {
		return sellingCost1;
	}

	public void setSellingCost1(String sellingCost1) {
		this.sellingCost1 = sellingCost1;
	}

	public String getSellingCost2() {
		return sellingCost2;
	}

	public void setSellingCost2(String sellingCost2) {
		this.sellingCost2 = sellingCost2;
	}

	public String getSellingCost3() {
		return sellingCost3;
	}

	public void setSellingCost3(String sellingCost3) {
		this.sellingCost3 = sellingCost3;
	}

	public String getSellingCost4() {
		return sellingCost4;
	}

	public void setSellingCost4(String sellingCost4) {
		this.sellingCost4 = sellingCost4;
	}

	public String getSellingCost5() {
		return sellingCost5;
	}

	public void setSellingCost5(String sellingCost5) {
		this.sellingCost5 = sellingCost5;
	}

	public String getSellingCost6() {
		return sellingCost6;
	}

	public void setSellingCost6(String sellingCost6) {
		this.sellingCost6 = sellingCost6;
	}

	public String getSellingCost7() {
		return sellingCost7;
	}

	public void setSellingCost7(String sellingCost7) {
		this.sellingCost7 = sellingCost7;
	}

	public String getSellingCost8() {
		return sellingCost8;
	}

	public void setSellingCost8(String sellingCost8) {
		this.sellingCost8 = sellingCost8;
	}

	public String getSellingCost9() {
		return sellingCost9;
	}

	public void setSellingCost9(String sellingCost9) {
		this.sellingCost9 = sellingCost9;
	}

	public String getSellingCost10() {
		return sellingCost10;
	}

	public void setSellingCost10(String sellingCost10) {
		this.sellingCost10 = sellingCost10;
	}

	public String getSellingCost11() {
		return sellingCost11;
	}

	public void setSellingCost11(String sellingCost11) {
		this.sellingCost11 = sellingCost11;
	}

	public String getSellingCost12() {
		return sellingCost12;
	}

	public void setSellingCost12(String sellingCost12) {
		this.sellingCost12 = sellingCost12;
	}

	public String getSalesQuantityNextyear() {
		return salesQuantityNextyear;
	}

	public void setSalesQuantityNextyear(String salesQuantityNextyear) {
		this.salesQuantityNextyear = salesQuantityNextyear;
	}

	public String getMaterialCostNextyear() {
		return materialCostNextyear;
	}

	public void setMaterialCostNextyear(String materialCostNextyear) {
		this.materialCostNextyear = materialCostNextyear;
	}

	public String getLaborCostNextyear() {
		return laborCostNextyear;
	}

	public void setLaborCostNextyear(String laborCostNextyear) {
		this.laborCostNextyear = laborCostNextyear;
	}

	public String getManufactureCostNextyear() {
		return manufactureCostNextyear;
	}

	public void setManufactureCostNextyear(String manufactureCostNextyear) {
		this.manufactureCostNextyear = manufactureCostNextyear;
	}

	public String getSellingCostNextyear() {
		return sellingCostNextyear;
	}

	public void setSellingCostNextyear(String sellingCostNextyear) {
		this.sellingCostNextyear = sellingCostNextyear;
	}

	public String getSalesQuantityTwoyear() {
		return salesQuantityTwoyear;
	}

	public void setSalesQuantityTwoyear(String salesQuantityTwoyear) {
		this.salesQuantityTwoyear = salesQuantityTwoyear;
	}

	public String getMaterialCostTwoyear() {
		return materialCostTwoyear;
	}

	public void setMaterialCostTwoyear(String materialCostTwoyear) {
		this.materialCostTwoyear = materialCostTwoyear;
	}

	public String getLaborCostTwoyear() {
		return laborCostTwoyear;
	}

	public void setLaborCostTwoyear(String laborCostTwoyear) {
		this.laborCostTwoyear = laborCostTwoyear;
	}

	public String getManufactureCostTwoyear() {
		return manufactureCostTwoyear;
	}

	public void setManufactureCostTwoyear(String manufactureCostTwoyear) {
		this.manufactureCostTwoyear = manufactureCostTwoyear;
	}

	public String getSellingCostTwoyear() {
		return sellingCostTwoyear;
	}

	public void setSellingCostTwoyear(String sellingCostTwoyear) {
		this.sellingCostTwoyear = sellingCostTwoyear;
	}

	public String getSalesQuantityThreeyear() {
		return salesQuantityThreeyear;
	}

	public void setSalesQuantityThreeyear(String salesQuantityThreeyear) {
		this.salesQuantityThreeyear = salesQuantityThreeyear;
	}

	public String getMaterialCostThreeyear() {
		return materialCostThreeyear;
	}

	public void setMaterialCostThreeyear(String materialCostThreeyear) {
		this.materialCostThreeyear = materialCostThreeyear;
	}

	public String getLaborCostThreeyear() {
		return laborCostThreeyear;
	}

	public void setLaborCostThreeyear(String laborCostThreeyear) {
		this.laborCostThreeyear = laborCostThreeyear;
	}

	public String getManufactureCostThreeyear() {
		return manufactureCostThreeyear;
	}

	public void setManufactureCostThreeyear(String manufactureCostThreeyear) {
		this.manufactureCostThreeyear = manufactureCostThreeyear;
	}

	public String getSellingCostThreeyear() {
		return sellingCostThreeyear;
	}

	public void setSellingCostThreeyear(String sellingCostThreeyear) {
		this.sellingCostThreeyear = sellingCostThreeyear;
	}

	public String getSalesQuantityFouryear() {
		return salesQuantityFouryear;
	}

	public void setSalesQuantityFouryear(String salesQuantityFouryear) {
		this.salesQuantityFouryear = salesQuantityFouryear;
	}

	public String getMaterialCostFouryear() {
		return materialCostFouryear;
	}

	public void setMaterialCostFouryear(String materialCostFouryear) {
		this.materialCostFouryear = materialCostFouryear;
	}

	public String getLaborCostFouryear() {
		return laborCostFouryear;
	}

	public void setLaborCostFouryear(String laborCostFouryear) {
		this.laborCostFouryear = laborCostFouryear;
	}

	public String getManufactureCostFouryear() {
		return manufactureCostFouryear;
	}

	public void setManufactureCostFouryear(String manufactureCostFouryear) {
		this.manufactureCostFouryear = manufactureCostFouryear;
	}

	public String getSellingCostFouryear() {
		return sellingCostFouryear;
	}

	public void setSellingCostFouryear(String sellingCostFouryear) {
		this.sellingCostFouryear = sellingCostFouryear;
	}
