...
public class PoEmailService extends BaseService<PoEmailLog> {
    ...
    public AjaxResult sendEmail(AjaxResult ajaxResult, String emailGroup, String title, String content,String endDate){
        ...
        if(emailListC.size()==0){
            ...
            content=content.replace("\n","</br>");
            content=content.replace(" ","&nbsp;");
            Boolean isSend = EmailUtil.emailsMany(emailListC, title,content+"</br>&nbsp;&nbsp;<a href=\"https://itpf-test.one-fit.com/fit/login\" style=\"color: blue;\">接口平臺</a><br></br>接口平臺登錄賬號是EIP賬號，密碼默認11111111，登錄如有問題，請聯系顧問 , 分機 5070-32202 , 郵箱：emji@deloitte.com.cn。<br></br>Best Regards!");
            if(isSend){
