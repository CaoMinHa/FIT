...
import foxconn.fit.dao.ebs.SSIReconciliationDao;
import foxconn.fit.entity.ebs.SSIReconciliation;
import foxconn.fit.service.base.BaseService;

@Service
@Transactional(rollbackFor = Exception.class)
public class SSIReconciliationService extends BaseService<SSIReconciliation>{
	
	@Autowired
	private SSIReconciliationDao reconciliationDao;
	
	@Override
	public BaseDaoHibernate<SSIReconciliation> getDao() {
		return reconciliationDao;
	}
	
	public void saveBatch(List<SSIReconciliation> list,String condition) throws Exception{
