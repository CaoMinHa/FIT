...
public class RtRevenueGrossProfitService{
    ...
    public Page<Object[]> selectDataSql(String queryCondition,PageRequest pageRequest) {
        String sql ="select ETL_DAY,YEAR_MONTH,ENTITY_SYSTEM,PRODUCT_CATEGORY,BU,SBU,BM_SBU,SEGMENT,FIT33,PRODUCT_TYPE,INDUSTRY,SUB_INDUSTRY,STRAGETY,SCREEN_CLOUD,\n" +
    ...
    public String uploadFile(MultipartHttpServletRequest multipartHttpServletRequest, AjaxResult result, Locale locale){
        try {
            ...
            if (mutipartFiles != null && mutipartFiles.size() > 0) {
                ...
                //240320
                Assert.isTrue(column == 24, instrumentClassService.getLanguage(locale, "請下載正確的模板上傳數據！", "Please download the correct template to upload the data"));
                ...
                for (int i = 0; i < rowNum; i++) {
                    ...
                    //240320
                    String sql="insert into BIDEV.if_rev_dtl_manual(YEAR_MONTH,ENTITY_SYSTEM,PRODUCT_CATEGORY,BU,SBU,BM_SBU,SEGMENT,FIT33,PRODUCT_TYPE,INDUSTRY,SUB_INDUSTRY,STRAGETY,SCREEN_CLOUD,\n" +
